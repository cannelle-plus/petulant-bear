...
let website = "/PetulantBear"

let githubLink = "http://github.com/cannelle-plus/PetulantBear"

// Specify more information about your project
let info =
  [ "project-name", "PetulantBear"
    "project-author", "Arthis"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/PetulantBear" ]
