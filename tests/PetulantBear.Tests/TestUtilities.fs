[<AutoOpen>]
module PetulantBear.Tests.TestUtilities
...
let runWithConfig handlers = runWith defaultConfig <| choose handlers
...
let akkaConfig = ConfigurationFactory.ParseString @"
            akka {
                actor {
                    deployment {
